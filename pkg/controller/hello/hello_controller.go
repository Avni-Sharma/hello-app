...
import (
	...
	appv1alpha1 "github.com/Avni-Sharma/hello-app/pkg/apis/app/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appv1alpha1.Hello{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *appv1alpha1.Hello) *corev1.Pod {
